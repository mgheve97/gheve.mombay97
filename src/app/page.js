  ...
  return (
    <>
      <div className={darkMode ? 'dark' : ''}>
          {/* {Navigation Button} */}
          <nav className="shadow fixed z-20 top-0 left-0 w-full dark:bg-cyan-800 bg-cyan-50">
            <div className="flex items-center justify-between mx-auto container px-6 py-4">
              <div className="flex sm:items-center">
                <i className="fa-solid fa-briefcase"></i>
                <p className="text-red-800 font-bold text-xl md:text-2xl">Portfolio</p>
              </div>
              <div className="flex sm:items-center">
          ...
          {/* {Home Page} */}
          <section className="dark:bg-cyan-800 bg-cyan-50">
              ...
              <div className="flex flex-col-reverse md:grid md:grid-cols-2 md:place-items-center gap-10 sm:gap-20">
                <div className="flex flex-col items-start ">
                  <div className="font-bold text-2xl flex flex-col">
                    <h2 className="text-3xl xl:text-6xl mt-3  dark:text-white">Gheve Mombay</h2>
                    <div className="w-max flex">
                      <span className="text-2xl xl:text-4xl mr-2 dark:text-white">a</span>
                      <span className="animate-typing overflow-hidden whitespace-nowrap text-2xl xl:text-4xl text-red-800 p-1">Software Developer</span>
                    </div>
                  </div>

                  <div className="flex items-center justify-start flex-row mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className=' fill-red-800 w-[30px]'><path d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm0 2v.511l-8 6.223-8-6.222V6h16zM4 18V9.044l7.386 5.745a.994.994 0 0 0 1.228 0L20 9.044 20.002 18H4z"></path></svg>
                  ...
                  <a href='https://mail.google.com/mail/?view=cm&fs=1&to=gheve.mombay97@gmail.com' className='cursor-pointer'>
                    <button className='rounded font-bold text-sm tracking-wide text-white hover:text-red-800 hover:bg-white border-2 border-red-800 hover:border-red-800 bg-red-800 px-7 py-3 mt-5'>CONTACT ME</button>
                  </a>
                </div>
          ...
          {/* {About Page}*/}
          <section className="h-auto xl:h-screen flex flex-col items-center pt-36 dark:bg-cyan-800 bg-cyan-50">
            <h3 className='text-red-800 font-bold text-3xl sm:text-4xl'>About Me</h3>
            <div className='container mx-auto px-6 grid md:grid-cols-2 xl:grid-cols-4 gap-10 mt-10 md:mt-20'>
              <div className='border-2 rounded p-1'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" className='animate-bounce fill-red-800 w-[50px]'><path d="m7.375 16.781 1.25-1.562L4.601 12l4.024-3.219-1.25-1.562-5 4a1 1 0 0 0 0 1.562l5 4zm9.25-9.562-1.25 1.562L19.399 12l-4.024 3.219 1.25 1.562 5-4a1 1 0 0 0 0-1.562l-5-4zm-1.649-4.003-4 18-1.953-.434 4-18z"></path></svg>
                  <p className='font-bold text-xl mt-1 text-gray-600 dark:text-white text-center'>API Development</p>
                  <ul className='list-disc mt-3 text-gray-400 font-bold dark:text-white'>
                    <li>Designs and develops APIs from scratch</li>
                    <li>Implements authentication and authorization.</li>
              ...
              <div className='border-2 rounded p-1'>
                <div className='flex flex-col content-center justify-center items-center p-10'>
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" className='animate-bounce fill-red-800 w-[50px]'><path d="M20.978 13.21a1 1 0 0 0-.396-1.024l-14-10a.999.999 0 0 0-1.575.931l2 17a1 1 0 0 0 1.767.516l3.612-4.416 3.377 5.46 1.701-1.052-3.357-5.428 6.089-1.218a.995.995 0 0 0 .782-.769zm-8.674.31a1 1 0 0 0-.578.347l-3.008 3.677L7.257 5.127l10.283 7.345-5.236 1.048z"></path></svg>
                  <p className='font-bold text-xl mt-1 text-gray-600 dark:text-white text-center'>UI Development</p>
                  <ul className='list-disc mt-3 text-gray-400 font-bold dark:text-white'>
          ...
          {/*{Skills}*/}
          <section class='h-auto flex flex-col items-center pt-20 dark:bg-cyan-800 bg-cyan-50 pb-32'>
          <h3 className='text-red-800 font-bold text-3xl sm:text-4xl'>Skills and Tools</h3>
          <div className='container mx-auto px-6 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 gap-5 sm:gap-10 mt-10 md:mt-20'>
            ...
            <div className='border-2 rounded p-1 hover:animate-bounce'>
              <div className='flex flex-col content-center justify-center items-center p-5 text-center'>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-red-800 w-[30px] '><path d="M18.5 9.51a4.22 4.22 0 0 1-1.91-1.34A5.77 5.77 0 0 0 12 6a4.72 4.72 0 0 0-5 4 3.23 3.23 0 0 1 3.5-1.49 4.32 4.32 0 0 1 1.91 1.35A5.77 5.77 0 0 0 17 12a4.72 4.72 0 0 0 5-4 3.2 3.2 0 0 1-3.5 1.51zm-13 4.98a4.22 4.22 0 0 1 1.91 1.34A5.77 5.77 0 0 0 12 18a4.72 4.72 0 0 0 5-4 3.23 3.23 0 0 1-3.5 1.49 4.32 4.32 0 0 1-1.91-1.35A5.8 5.8 0 0 0 7 12a4.72 4.72 0 0 0-5 4 3.2 3.2 0 0 1 3.5-1.51z"></path></svg>
            ...
            <div className='border-2 rounded p-1 hover:animate-bounce'>
              <div className='flex flex-col content-center justify-center items-center p-5 text-center'>
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-red-800 w-[30px] '><path d="M17.5 4C15.57 4 14 5.57 14 7.5c0 1.554 1.025 2.859 2.43 3.315-.146.932-.547 1.7-1.23 2.323-1.946 1.773-5.527 1.935-7.2 1.907V8.837c1.44-.434 2.5-1.757 2.5-3.337C10.5 3.57 8.93 2 7 2S3.5 3.57 3.5 5.5c0 1.58 1.06 2.903 2.5 3.337v6.326c-1.44.434-2.5 1.757-2.5 3.337C3.5 20.43 5.07 22 7 22s3.5-1.57 3.5-3.5c0-.551-.14-1.065-.367-1.529 2.06-.186 4.657-.757 6.409-2.35 1.097-.997 1.731-2.264 1.904-3.768C19.915 10.438 21 9.1 21 7.5 21 5.57 19.43 4 17.5 4zm-12 1.5C5.5 4.673 6.173 4 7 4s1.5.673 1.5 1.5S7.827 7 7 7s-1.5-.673-1.5-1.5zM7 20c-.827 0-1.5-.673-1.5-1.5a1.5 1.5 0 0 1 1.482-1.498l.13.01A1.495 1.495 0 0 1 7 20zM17.5 9c-.827 0-1.5-.673-1.5-1.5S16.673 6 17.5 6s1.5.673 1.5 1.5S18.327 9 17.5 9z"></path></svg>
            ...
            <div className='border-2 rounded p-1 hover:animate-bounce'>
              <div className='flex flex-col content-center justify-center items-center p-5 text-center'>
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-red-800 w-[30px] '><path d="M6.01 2c-1.93 0-3.5 1.57-3.5 3.5 0 1.58 1.06 2.903 2.5 3.337v7.16c-.001.179.027 1.781 1.174 2.931C6.892 19.64 7.84 20 9 20v2l4-3-4-3v2c-1.823 0-1.984-1.534-1.99-2V8.837c1.44-.434 2.5-1.757 2.5-3.337 0-1.93-1.571-3.5-3.5-3.5zm0 5c-.827 0-1.5-.673-1.5-1.5S5.183 4 6.01 4s1.5.673 1.5 1.5S6.837 7 6.01 7zm13 8.163V7.997C19.005 6.391 17.933 4 15 4V2l-4 3 4 3V6c1.829 0 2.001 1.539 2.01 2v7.163c-1.44.434-2.5 1.757-2.5 3.337 0 1.93 1.57 3.5 3.5 3.5s3.5-1.57 3.5-3.5c0-1.58-1.06-2.903-2.5-3.337zm-1 4.837c-.827 0-1.5-.673-1.5-1.5s.673-1.5 1.5-1.5 1.5.673 1.5 1.5-.673 1.5-1.5 1.5z"></path></svg>
            ...
            <div className='border-2 rounded p-1 hover:animate-bounce'>
              <div className='flex flex-col content-center justify-center items-center p-5 text-center'>
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-red-800 w-[30px] '><path d="M19.01 15.163V7.997C19.005 6.391 17.933 4 15 4V2l-4 3 4 3V6c1.829 0 2.001 1.539 2.01 2v7.163c-1.44.434-2.5 1.757-2.5 3.337 0 1.93 1.57 3.5 3.5 3.5s3.5-1.57 3.5-3.5c0-1.58-1.06-2.903-2.5-3.337zm-1 4.837c-.827 0-1.5-.673-1.5-1.5s.673-1.5 1.5-1.5 1.5.673 1.5 1.5-.673 1.5-1.5 1.5zM9.5 5.5C9.5 3.57 7.93 2 6 2S2.5 3.57 2.5 5.5c0 1.58 1.06 2.903 2.5 3.337v6.326c-1.44.434-2.5 1.757-2.5 3.337C2.5 20.43 4.07 22 6 22s3.5-1.57 3.5-3.5c0-1.58-1.06-2.903-2.5-3.337V8.837C8.44 8.403 9.5 7.08 9.5 5.5zm-5 0C4.5 4.673 5.173 4 6 4s1.5.673 1.5 1.5S6.827 7 6 7s-1.5-.673-1.5-1.5zm3 13c0 .827-.673 1.5-1.5 1.5s-1.5-.673-1.5-1.5S5.173 17 6 17s1.5.673 1.5 1.5z"></path></svg>
            ...
            <div className='border-2 rounded p-1 hover:animate-bounce'>
              <div className='flex flex-col content-center justify-center items-center p-5 text-center'>
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-red-800 w-[30px] '><path fill-rule="evenodd" clip-rule="evenodd" d="M12.026 2c-5.509 0-9.974 4.465-9.974 9.974 0 4.406 2.857 8.145 6.821 9.465.499.09.679-.217.679-.481 0-.237-.008-.865-.011-1.696-2.775.602-3.361-1.338-3.361-1.338-.452-1.152-1.107-1.459-1.107-1.459-.905-.619.069-.605.069-.605 1.002.07 1.527 1.028 1.527 1.028.89 1.524 2.336 1.084 2.902.829.091-.645.351-1.085.635-1.334-2.214-.251-4.542-1.107-4.542-4.93 0-1.087.389-1.979 1.024-2.675-.101-.253-.446-1.268.099-2.64 0 0 .837-.269 2.742 1.021a9.582 9.582 0 0 1 2.496-.336 9.554 9.554 0 0 1 2.496.336c1.906-1.291 2.742-1.021 2.742-1.021.545 1.372.203 2.387.099 2.64.64.696 1.024 1.587 1.024 2.675 0 3.833-2.33 4.675-4.552 4.922.355.308.675.916.675 1.846 0 1.334-.012 2.41-.012 2.737 0 .267.178.577.687.479C19.146 20.115 22 16.379 22 11.974 22 6.465 17.535 2 12.026 2z"></path></svg>
        ...
        {/* {Works} */}
        <section class='dark:bg-cyan-800 bg-cyan-50 pb-40'>
          <div className='container mx-auto px-6 h-auto flex flex-col items-center pt-36'>
            <h3 className='text-red-800 font-bold text-3xl sm:text-4xl'>Works</h3>
            <div className='grid gap-10 lg:grid-cols-2 md:gap-20 mt-10 md:mt-20'>

              {/* item */}
              <div className='grid grid-cols-1 rounded p-1'>
                <div className=' flex justify-center items-center'>
                  <Image src={codeicon} alt='image' className='rounded'/>
                </div>
                <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                  <h3 className='font-bold text-2xl md:text-3xl text-red-800'>Portfolio - Gheve Mombay (2024)</h3>
                  <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Personal page</p>     
                  <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>HTML • CSS • Javascript • Reactjs • TailwindCSS</p>
                  <a target="_blank" href='gheve-mombay97.vercel.app'>
              ...
              <div className='grid grid-cols-1 rounded p-1'>
                ...
                <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                  <h3 className='font-bold text-2xl md:text-3xl text-red-800'>Bulletin Board (Ongoing Project)</h3>
                  <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Personal project</p>        
                  <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>Reactjs • CRUD • API</p>
            ...
            <div className='grid grid-cols-1 rounded p-1'>
              ...
              <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                <h3 className='font-bold text-2xl md:text-3xl text-red-800'>User Authentication System (2024)</h3>
                <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Personal project</p>        
                <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>Reactjs • MySQL Database • Localhost • API (Expressjs)</p>
                <a target="_blank" href='https://github.com/mgheve97/User-Authentication-System'>
                  <button className='flex flex-row text-white group hover:text-red-800 hover:bg-[#FCF7ED] hover:border-red-800 border-2  border-red-800 bg-red-800 font-semibold rounded px-5 py-[10px] mt-6'>           
                    <span className='mr-4'>view github</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-white  group-hover:fill-red-800 w-[30px] animate-bounce'><path d="m13 3 3.293 3.293-7 7 1.414 1.414 7-7L21 11V3z"></path><path d="M19 19H5V5h7l-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2v-5l-2-2v7z"></path></svg>
                  </button>
            ...
            <div className='grid grid-cols-1 rounded p-1'>
              ...
              <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                <h3 className='font-bold text-2xl md:text-3xl text-red-800'>NoteApp (2024)</h3>
                <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Personal project</p>        
            ...
            <div className='grid grid-cols-1 rounded p-1'>
              ...
              <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                <h3 className='font-bold text-2xl md:text-3xl text-red-800'>Meme Generator (2024)</h3>
                <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Project course by Scrimba 💜</p>        
                <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>Reactjs • API </p>
                <a target="_blank" href='https://github.com/mgheve97/meme-generator'>
                  <button className='flex flex-row text-white group hover:text-red-800 hover:bg-[#FCF7ED] hover:border-red-800 border-2  border-red-800 bg-red-800 font-semibold rounded px-5 py-[10px] mt-6'>           
                    <span className='mr-4'>view github</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-white  group-hover:fill-red-800 w-[30px] animate-bounce'><path d="m13 3 3.293 3.293-7 7 1.414 1.414 7-7L21 11V3z"></path><path d="M19 19H5V5h7l-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2v-5l-2-2v7z"></path></svg>
                  </button>
            ...
            <div className='grid grid-cols-1 rounded p-1'>
              ...
              <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                <h3 className='font-bold text-2xl md:text-3xl text-red-800'>Airbnb landing page (2024)</h3>
                <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Project course by Scrimba 💜</p>        
                <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>Reactjs • SASS • API</p>
                <a target="_blank" href='https://github.com/mgheve97/AirBnB-Project'>
                  <button className='flex flex-row text-white group hover:text-red-800 hover:bg-[#FCF7ED] hover:border-red-800 border-2  border-red-800 bg-red-800 font-semibold rounded px-5 py-[10px] mt-6'>           
                    <span className='mr-4'>view github</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-white  group-hover:fill-red-800 w-[30px] animate-bounce'><path d="m13 3 3.293 3.293-7 7 1.414 1.414 7-7L21 11V3z"></path><path d="M19 19H5V5h7l-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2v-5l-2-2v7z"></path></svg>
                  </button>
            ...
            <div className='grid grid-cols-1 rounded p-1'>
              ...
              <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                <h3 className='font-bold text-2xl md:text-3xl text-red-800'>Chabot (2024)</h3>
                <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Personal project</p>        
                <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>Python • FastAPI • HTML • CSS • Javascript • NLTK • Keras </p>
                <a target="_blank" href='https://github.com/mgheve97/Maia-Chatbot'>
                  <button className='flex flex-row text-white group hover:text-red-800 hover:bg-[#FCF7ED] hover:border-red-800 border-2  border-red-800 bg-red-800 font-semibold rounded px-5 py-[10px] mt-6'>           
                    <span className='mr-4'>view github</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-white  group-hover:fill-red-800 w-[30px] animate-bounce'><path d="m13 3 3.293 3.293-7 7 1.414 1.414 7-7L21 11V3z"></path><path d="M19 19H5V5h7l-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2v-5l-2-2v7z"></path></svg>
                  </button>
            ...
            <div className='grid grid-cols-1 rounded p-1'>
              ...
              <div className=' flex flex-col justify-center items-start xl:ml-5 mt-4 xl:mt-0'>
                <h3 className='font-bold text-2xl md:text-3xl text-red-800'>FishCam (2022)</h3>
                <p className='font-bold text-lg md:text-2xl mt-1 text-gray-600 dark:text-white'>Lead Programmer - Thesis</p>        
                <p className='font-bold mt-4 md:mt-5 text-sm text-gray-400 dark:text-white'>Java • Android Studio • Database</p>
                <a target="_blank" href='https://github.com/mgheve97/FishCam'>
                  <button className='flex flex-row text-white group hover:text-red-800 hover:bg-[#FCF7ED] hover:border-red-800 border-2  border-red-800 bg-red-800 font-semibold rounded px-5 py-[10px] mt-6'>           
                    <span className='mr-4'>view github</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className='fill-white  group-hover:fill-red-800 w-[30px] animate-bounce'><path d="m13 3 3.293 3.293-7 7 1.414 1.414 7-7L21 11V3z"></path><path d="M19 19H5V5h7l-2-2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2v-5l-2-2v7z"></path></svg>
                  </button>
